...
public class Ejercicio7_2Activity extends AppCompatActivity {
    ...
    private final String numeroEjercicio = "7_2";
    ...
    private void startRecording() {
        try {
            File file = new File(getExternalFilesDir(null), "audio_ejercicio7_2_trabalenguas.mp4");
        ...
        ref.putFile(file)
                .addOnSuccessListener(taskSnapshot -> {
                    ref.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Log.d("EJERCICIO_7_2", "URL: " + uri.toString());
                    });
                })
                .addOnFailureListener(e -> {
                    Log.e("EJERCICIO_7_2", "Error al subir", e);
