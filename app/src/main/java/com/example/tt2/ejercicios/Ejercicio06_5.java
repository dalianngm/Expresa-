...
public class Ejercicio06_5 extends AppCompatActivity implements View.OnClickListener {
    ...
    // VISTAS
    ImageView ivRegresarEje065;
    TextView tvLecturaEje065;
    Button btnAudioInstruccionesEje065, btnAudioTrabalenguasEje065, btnGrabarEje065, btnDetenerEje065, btnSubirEje065;
        ...
        ref.putFile(file)
                .addOnSuccessListener(taskSnapshot ->
                        ref.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Log.d("EJERCICIO_6_5", "URL: " + uri.toString());
                        })
                )
                .addOnFailureListener(e -> {
                    Log.e("EJERCICIO_6_5", "Error al subir", e);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ivRegresarEje065) { finish(); }

        else if (v.getId() == R.id.btnAudioInstruccionesEje065) {
            if (mediaPlayerInstrucciones != null) {
        ...
        }else if (v.getId() == R.id.btnAudioTrabalenguasEje065) {
            reproducirAudios(R.raw.trabalenguas_eje6_5);
        }

        else if (v.getId() == R.id.btnGrabarEje065) {
        ...
        else if (v.getId() == R.id.btnDetenerEje065) { stopRecording();}

        else if (v.getId() == R.id.btnSubirEje065) { uploadAudio(); }
    }
